...
public class ResourcesController {
    ...
    public List<Permission> resourcesWithSelected(Integer rid){
        return permissionService.queryResourcesListWithSelected(rid);
    }
    ...
    public List<Permission> loadMenu(){
        ...
        List<Permission> resourcesList = permissionService.loadUserResources(map);
